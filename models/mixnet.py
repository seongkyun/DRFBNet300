...
class MixNet(nn.Module):
    ...
    mixnet_b = [(1024,  1024,  [3],              [1],    [1],    1, 1, 'ReLU',  0.0),
                (1024//4,  1024//4,  [3],              [1, 1], [1, 1], 2, 6, 'ReLU',  0.0),
                (1024//4,  1024//4,  [3],              [1, 1], [1, 1], 1, 3, 'ReLU',  0.0),
                (1024//4,  1024//2,  [3, 5, 7],        [1],    [1],    2, 6, 'Swish', 0.5)]
    ...
    def __init__(self, net_type='mixnet_s', input_size=224, num_classes=1000, stem_channels=16, feature_size=1536, depth_multiplier=1.0):
        ...
        if net_type == 'mixnet_s':
            ...
            dropout_rate = 0.25
        elif net_type == 'mixnet_b':
            config = self.mixnet_b
            stem_channels = 1024
            dropout_rate = 0.2
        else:
